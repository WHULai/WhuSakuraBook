...
\titlepage % Output the title page
    ...
    { % Title(s) and author(s)
        ...
        {\Huge\bfseries 武汉大学樱花\par} % Book title
        \vspace{12pt} % Vertical whitespace
        {\LARGE \LaTeX 模板\par} % Subtitle
...
\chapter*{前言}
    ...
    作者本人于2024年从江西省参加高考，有幸被武汉大学录取。我从高中开始接触
	\LaTeX，被其专业的排版风格所吸引。

    2025春季学期，我总结上学期期末考试的经验教训，这学期决定采用\LaTeX 记笔记巩固学习成果。

    我最开始使用\href{https://github.com/YZ-Cai/LatexHomeworkTemplate/tree/main }{Latex Homework Template}
    记录错题，后由于许多老师授课风格偏快，决定课下将课上尚未完善的笔记使用\LaTeX 整理。
    前几日我发现了\href{https://www.latextemplates.com/template/legrand-orange-book }{Legrand Orange Book}
    模板，令我十分欣喜。所以我简单地换了几个图片，更改了主题颜色，添加了几个\mintinline{LaTeX}|newcommand|，
    形成了这套武大樱花\LaTeX 模板。
...
\begin{figure}[H] % Use [H] to suppress floating and place the figure/table exactly where it is specified in the text
	...
	\includegraphics[width=0.5\textwidth]{logo.png} % Include the figure image
